...
`,e.jsxs(s.h2,{id:"import-agents-from-the-coconut-registry",children:["Import Agents from the Coconut Registry",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#import-agents-from-the-coconut-registry",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(s.p,{children:["Need a starting point quickly? The Agents page includes a ",e.jsx(s.strong,{children:"Registry"})," button (next to ",e.jsx(s.strong,{children:"Create New"}),") that connects directly to ",e.jsx(s.code,{children:"registry.coconut.dev"}),"."]}),`
`,e.jsxs(s.ol,{children:[`
`,e.jsxs(s.li,{children:["Click ",e.jsx(s.strong,{children:"Registry"})," to open the in-app browser."]}),`
`,e.jsx(s.li,{children:"Use the search bar or tag badges to find a template that fits your workflow."}),`
`,e.jsx(s.li,{children:"Selecting a card loads a preview built from the registry payload—tools, focus areas, and the full Markdown body are all visible in a scrollable panel."}),`
`,e.jsxs(s.li,{children:["Click ",e.jsx(s.strong,{children:"Import Agent"})," to download the definition. Coconut writes the file to ",e.jsx(s.code,{children:".nut/agents/"})," via the existing ",e.jsx(s.code,{children:"/api/v1/agents"})," endpoint."]}),`
`,e.jsx(s.li,{children:"The Agents page refreshes immediately so the imported entry appears without reloading."}),`
`]}),`
`,e.jsxs(s.p,{children:["Imported agents follow the same frontmatter schema documented in ",e.jsx(s.code,{children:".nut/.schema/agent.schema.md"}),", so they are ready to edit, schedule, or launch just like a locally-authored profile."]}),`
