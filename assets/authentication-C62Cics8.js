...
`,s.jsxs(e.li,{children:[s.jsx(e.strong,{children:"File-based storage"})," - No database required, auth config stored in OS application data directory"]}),`
...
`,s.jsx(s.Fragment,{children:s.jsx(e.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:s.jsx(e.code,{children:s.jsxs(e.span,{className:"line",children:[s.jsx(e.span,{style:{color:"#6F42C1","--shiki-dark":"#F69D50"},children:"nut"}),s.jsx(e.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" auth"}),s.jsx(e.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" init"})]})})})}),`
`,s.jsx(e.p,{children:"You'll be prompted for:"}),`
`,s.jsxs(e.ul,{children:[`
`,s.jsx(e.li,{children:"Admin email address"}),`
`,s.jsx(e.li,{children:"Admin name"}),`
`,s.jsx(e.li,{children:"Whether to enable authentication immediately"}),`
`]}),`
`,s.jsx(e.p,{children:"To skip the prompts and run non-interactively (useful for CI/CD or scripting):"}),`
`,s.jsx(s.Fragment,{children:s.jsx(e.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:s.jsxs(e.code,{children:[s.jsxs(e.span,{className:"line",children:[s.jsx(e.span,{style:{color:"#6F42C1","--shiki-dark":"#F69D50"},children:"nut"}),s.jsx(e.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" auth"}),s.jsx(e.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" init"}),s.jsx(e.span,{style:{color:"#005CC5","--shiki-dark":"#F47067"},children:" \\"})]}),`
`,s.jsxs(e.span,{className:"line",children:[s.jsx(e.span,{style:{color:"#005CC5","--shiki-dark":"#6CB6FF"},children:"  --email"}),s.jsx(e.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:' "admin@example.com"'}),s.jsx(e.span,{style:{color:"#005CC5","--shiki-dark":"#F47067"},children:" \\"})]}),`
`,s.jsxs(e.span,{className:"line",children:[s.jsx(e.span,{style:{color:"#005CC5","--shiki-dark":"#6CB6FF"},children:"  --name"}),s.jsx(e.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:' "Admin User"'}),s.jsx(e.span,{style:{color:"#005CC5","--shiki-dark":"#F47067"},children:" \\"})]}),`
`,s.jsxs(e.span,{className:"line",children:[s.jsx(e.span,{style:{color:"#005CC5","--shiki-dark":"#6CB6FF"},children:"  --enable"}),s.jsx(e.span,{style:{color:"#005CC5","--shiki-dark":"#F47067"},children:" \\"})]}),`
`,s.jsx(e.span,{className:"line",children:s.jsx(e.span,{style:{color:"#005CC5","--shiki-dark":"#6CB6FF"},children:"  --force"})})]})})}),`
`,s.jsx(e.strong,{children:"Available flags:"}),`
`,s.jsxs(e.table,{children:[s.jsx(e.thead,{children:s.jsxs(e.tr,{children:[s.jsx(e.th,{children:"Flag"}),s.jsx(e.th,{children:"Description"})]})}),s.jsxs(e.tbody,{children:[s.jsxs(e.tr,{children:[s.jsx(e.td,{children:s.jsx(e.code,{children:"-e, --email <email>"})}),s.jsx(e.td,{children:"Admin email address"})]}),s.jsxs(e.tr,{children:[s.jsx(e.td,{children:s.jsx(e.code,{children:"-n, --name <name>"})}),s.jsx(e.td,{children:'Admin name (default: "Admin")'})]}),s.jsxs(e.tr,{children:[s.jsx(e.td,{children:s.jsx(e.code,{children:"--enable"})}),s.jsx(e.td,{children:"Enable authentication immediately"})]}),s.jsxs(e.tr,{children:[s.jsx(e.td,{children:s.jsx(e.code,{children:"-f, --force"})}),s.jsx(e.td,{children:"Overwrite existing auth.json without prompting"})]})]})]}),`
`,s.jsxs(e.p,{children:["This creates ",s.jsx(e.code,{children:"auth.json"})," in your OS application data directory with ",s.jsx(e.code,{children:"enabled: false"})," by default (unless ",s.jsx(e.code,{children:"--enable"})," is passed):"]}),`
`,s.jsxs(e.ul,{children:[`
`,s.jsxs(e.li,{children:[s.jsx(e.strong,{children:"macOS:"})," ",s.jsx(e.code,{children:"~/Library/Application Support/coconuts/auth.json"})]}),`
`,s.jsxs(e.li,{children:[s.jsx(e.strong,{children:"Windows:"})," ",s.jsx(e.code,{children:"%APPDATA%\\coconuts\\auth.json"})]}),`
`,s.jsxs(e.li,{children:[s.jsx(e.strong,{children:"Linux:"})," ",s.jsx(e.code,{children:"~/.local/share/coconuts/auth.json"})]}),`
`]}),`
`,s.jsxs(e.p,{children:["You can override this location with the ",s.jsx(e.code,{children:"COCONUT_DATA_DIR"})," environment variable."]}),`
...
`]}),`
`,s.jsxs(e.h3,{id:"file-location--permissions",children:["File Location & Permissions",s.jsx(e.a,{"aria-hidden":"true",tabIndex:"-1",href:"#file-location--permissions",children:s.jsx(e.div,{"data-autolink-icon":!0})})]}),`
`,s.jsx(e.p,{children:"Authentication configuration is stored in your OS application data directory (not in your project), so it:"}),`
`,s.jsxs(e.ul,{children:[`
`,s.jsx(e.li,{children:"Won't accidentally be committed to version control"}),`
`,s.jsx(e.li,{children:"Is shared across all Coconut projects on your machine"}),`
`,s.jsx(e.li,{children:"Contains sensitive data that should be protected"}),`
`]}),`
`,s.jsx(e.p,{children:"The file contains:"}),`
`,s.jsxs(e.ul,{children:[`
`,s.jsx(e.li,{children:"Password hashes"}),`
`,s.jsx(e.li,{children:"Session secrets"}),`
`,s.jsx(e.li,{children:"API key hashes"}),`
`]}),`
`,s.jsx(e.p,{children:"Ensure appropriate file permissions on your system to protect this data."}),`
...
`,s.jsxs(e.p,{children:[s.jsx(e.code,{children:"auth.json"})," in your OS application data directory (created by ",s.jsx(e.code,{children:"nut auth init"}),"):"]}),`
...
`,s.jsxs(e.ol,{children:[`
`,s.jsxs(e.li,{children:["Edit ",s.jsx(e.code,{children:"auth.json"})," directly (in your OS app data directory) to add a new admin user"]}),`
`,s.jsxs(e.li,{children:["Or delete the ",s.jsx(e.code,{children:"auth.json"})," file and run ",s.jsx(e.code,{children:"nut auth init"})," again"]}),`
`]}),`
`,s.jsx(e.p,{children:"To find the auth.json location on your system:"}),`
`,s.jsxs(e.ul,{children:[`
`,s.jsxs(e.li,{children:[s.jsx(e.strong,{children:"macOS:"})," ",s.jsx(e.code,{children:"~/Library/Application Support/coconuts/auth.json"})]}),`
`,s.jsxs(e.li,{children:[s.jsx(e.strong,{children:"Windows:"})," ",s.jsx(e.code,{children:"%APPDATA%\\coconuts\\auth.json"})]}),`
`,s.jsxs(e.li,{children:[s.jsx(e.strong,{children:"Linux:"})," ",s.jsx(e.code,{children:"~/.local/share/coconuts/auth.json"})]}),`
